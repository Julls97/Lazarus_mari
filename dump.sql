...
SELECT pg_catalog.setval('public.parent_ids', 10, true);
...
--
-- Name: TABLE childs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.childs TO role_admin;
GRANT SELECT,INSERT,UPDATE ON TABLE public.childs TO role_operator;
GRANT SELECT ON TABLE public.childs TO role_user;
...
GRANT ALL ON TABLE public.groups TO role_admin;
GRANT SELECT,INSERT,UPDATE ON TABLE public.groups TO role_operator;
GRANT SELECT ON TABLE public.groups TO role_user;


--
-- Name: TABLE kindergarteners; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.kindergarteners TO role_admin;
GRANT SELECT,INSERT,UPDATE ON TABLE public.kindergarteners TO role_operator;
GRANT SELECT ON TABLE public.kindergarteners TO role_user;
...
GRANT ALL ON TABLE public.parents TO role_admin;
GRANT SELECT,INSERT,UPDATE ON TABLE public.parents TO role_operator;
GRANT SELECT ON TABLE public.parents TO role_user;
...
GRANT ALL ON TABLE public.records TO role_admin;
GRANT SELECT,INSERT,UPDATE ON TABLE public.records TO role_operator;
GRANT SELECT ON TABLE public.records TO role_user;
